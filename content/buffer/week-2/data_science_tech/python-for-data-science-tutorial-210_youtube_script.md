...
[CODE_INSERT: mkdir python_data_science && cd python_data_science; python3 -m venv env; source env/bin/activate]
...
[CODE_INSERT: first_script.py with people list of dictionaries, loop calculating total_age and average_age, JSON output to results.json]
