...
def build_prompt(writing_agent: str, master_brief: str, topic: str, niche: str) -> str:
    niche_label = {
...
def main():
    ...
    combined_prompt = build_prompt(writing_agent, master_brief, args.topic, args.niche)
