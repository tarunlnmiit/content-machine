...
### Component Catalog (12 components)
...
| `ImageTextReveal` | Narrative peak, emotional beat — headline on image | life, poetry | fullscreen or panel |
...
- Fullscreen components auto-coerced if model assigns panel layout: `DataVizReveal`, `CodeAnnotation`, `ToolComparison`, `ConceptExplainer`, `CounterReveal`.
